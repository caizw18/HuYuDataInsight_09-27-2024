...
# Fetch Uber's current stock price
ticker = 'UBER'
data = yf.Ticker(ticker)
current_price = data.history(period='1d')['Close'].iloc[-1]

# Parameters for the Black-Scholes model
S = current_price  # Current stock price of Uber (UBER)
K = 50  # Strike price (you can change this value)
...
# Print the results
print(f"Uber Technologies (UBER) Current Stock Price: {S:.2f}")
...
# Uber Technologies (UBER) Current Stock Price: 47.89
# Strike Price: 50
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.40
# Call Option Price: 6.01
# Put Option Price: 8.56